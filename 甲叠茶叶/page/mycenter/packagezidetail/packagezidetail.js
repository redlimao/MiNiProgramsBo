// pages/packagezidetail/packagezidetail.js
        ...
        wx.request({
            ...
            success: function(res) {
                ...
                that.setData({
                    ...
                    xiang_name: res.data.info.xiang_name,
                    specialist_name: res.data.info.specialist_name,
                    water_name: res.data.info.water_name,
                    food_name: res.data.info.food_name,
