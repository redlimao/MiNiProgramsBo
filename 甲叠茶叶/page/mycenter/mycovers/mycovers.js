...
Page({
    ...
    onLoad: function (options) {
        ...
        wx.login({
            success: function(res) {
                if(res.code){
                    wx.request({
                        url: util.host + '/Little/Center/covers',
    ...
    //积分规则
    bindCoverDetail:function(e){
        let index = e.currentTarget.dataset.index;
        wx.navigateTo({
            url: '../../mycenter/rule/rule?index=' + index,
        })
    },
    tabFun: function (e) {
        util.showload('加载中');
        ...
        wx.login({
            success: function (res) {
                if (res.code) {
                    wx.request({
                        url: util.host + '/Little/Center/score_more',
