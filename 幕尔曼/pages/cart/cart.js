    ...
    wx.login({
      success: function (ress) {
        if (ress.code) {
          ...
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Center/carss',
            data: { code: ress.code },
            method: "GET",
  ...
  delName(e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Del/index',
