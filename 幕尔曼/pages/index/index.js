...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Goods/indexs',
  ...
  onPullDownRefresh: function () {
    var that = this;
    wx.request({
      url: 'https://www.bozhiyingxiao.com/little_program/store_mrm//index.php?s=/Little/Goods/index',
      data: {},
      method: "GET",
      success: function (res) {
        if (res.data.goods == 1) {
  ...
  lingName:function(){
    ...
    wx.login({
      success:function(ress){
        if(ress.code){
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_mrm//index.php?s=/Little/Goods/coupons',
            data:{code:ress.code},
            method:"GET",
            success:function(res){
              if(res.data==1){
