...
Page({
    ...
    wx.login({
      success:function(ress){
        if(ress.code){
          ...
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Info/goodss',
  ...
  collectName: function () {
    ...
    wx.login({
      success: function (ress) {
        if (ress.code) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Collect/indexs',
  ...
  pingName:function(e){
    ...
    var that = this;
    wx.request({
      url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Goods/pings',
  ...
  jiaName:function(){
    ...
    wx.login({
      success:function(ress){
        if(ress.code){
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Goods/carss',
        ...
        if (ress.code) {
          wx.chooseAddress({
            success:function(resss){
              ...
              wx.request({
                url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/pay/example/jsapi.php',
                ...
                success: function (res) {
                  wx.requestPayment({
                    ...
                    'success': function (ress) {
                      ...
                      wx.request({
                        url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Orders/indexs',
                        data: { no: res.data.no, op: res.data.op, shop_num: carts[0].shop_num, address: address, moneys: totalPrice, xing: size, type: 1, covers: points, status: 1, id: carts[0].id, name: resss.userName, phone: resss.telNumber, orders_id: orders_id, types_s: types_id, you_id: you_id, you_jian: you_jian},
                        method: 'GET',
                        success: function (res) {
                        }
                      })
                    ...
                    'complete': function (ress) {
                      if (ress.errMsg == "requestPayment:fail cancel"){
                        wx.request({
                          url: 'https://www.bozhiyingxiao.com/little_program/store_mrm/index.php?s=/Little/Orders/indexs',
                          data: { no: res.data.no, op: res.data.op, shop_num: carts[0].shop_num, address: address, moneys: totalPrice, xing: size, type: 1, covers: points, status: 2, id: carts[0].id, name: resss.userName, phone: resss.telNumberorders_id, orders_id, types_s: types_id, you_id: you_id, you_jian: you_jian},
                          method: 'GET',
                          success: function (res) {
                            that.setData({
                              dan: 0
