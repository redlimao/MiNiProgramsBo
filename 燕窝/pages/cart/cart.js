  ...
  onLoad: function (options) {
    ...
    wx.login({
      success: function (ress) {
        if (ress.code) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/store_yanwo/link.php?s=/User/cars',
            data: { code: ress.code },
            method: "GET",
  ...
  delName(e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/store_yanwo/link.php?s=/Del/index',
                ...
                success: function (res) {
                  wx.requestPayment({
                    ...
                    'complete': function (ress) {
                      console.log(ress);
                      if (ress.errMsg == "requestPayment:cancel") {
                        wx.request({
                          url: 'https://www.bozhiyingxiao.com/store_yanwo/link.php?s=/Orders/index',
