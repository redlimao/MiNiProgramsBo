                ...
                if(ress.code){
                    ...
                    wx.getUserInfo({
                        success: function (res) {
                            ...
                            wx.request({
                                url: 'https://www.bozhiyingxiao.com/little_program/store_lianjia/index.php?s=/Little/Index/index',
                                data: { jing: that.data.longitude, wei: that.data.latitude, code: ress.code, img: avatarUrl, sex: gender, name: nickName, city: city, pro: province, cou: country},
                                method: 'GET',
                                success: function (res) {
                                    console.log(res);
                                    that.setData({
    ...
    bindTab:function(e){
        ...
        wx.login({
            success:function(ress){
                if(ress.code){
                    wx.request({
                        url: 'https://www.bozhiyingxiao.com/little_program/store_lianjia/index.php?s=/Little/Index/type_qie',
        ...
        if (qing == 0) {
            ...
            wx.login({
                success:function(ress){
                    if(ress.code){
                        wx.request({
                            url: 'https://www.bozhiyingxiao.com/little_program/store_lianjia/index.php?s=/Little/Index/la',
