...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.login({
      success:function(ress){
        if(ress.code){
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_meitian/index.php?s=/Little/Center/covers',
            data: { code:ress.code },
            method: "GET",
  ...
  tabFun: function (e) {
    ...
    wx.request({
      url: 'https://www.bozhiyingxiao.com/little_program/store_meitian/index.php?s=/Little/Center/zhi_shou',
