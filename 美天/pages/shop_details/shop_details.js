...
Page({
  ...
  onShow: function (options) {
    ...
    wx.login({
      success:function(ress){
        console.log(shop_id, ress.code, types_id)
        if(ress.code){
          wx.showLoading({
            title: '加载中',
          })
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_meitian/index.php?s=/Little/Info/goodss',
  ...
  collectName: function () {
    ...
    wx.login({
      success: function (ress) {
        if (ress.code) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_meitian/index.php?s=/Little/Collect/indexs',
  ...
  pingName:function(e){
    ...
    console.log(e)
    wx.request({
      url: 'https://www.bozhiyingxiao.com/little_program/store_meitian/index.php?s=/Little/Goods/pings',
  ...
  jiaName:function(){
    ...
    wx.login({
      success:function(ress){
        if(ress.code){
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_meitian/index.php?s=/Little/Goods/carss',
  ...
  zhiName: function () {
    ...
    // console.log(flag_dao, dian_id, you_id,you,you_jian)
    wx.login({
      success: function (ress) {
        if (ress.code) {
          wx.chooseAddress({
