  ...
  onLoad: function (options) {
    ...
    wx.login({
      success: function (ress) {
        if (ress.code) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_love/index.php?s=/Little/Center/orderss',
  ...
  queName: function (e) {
    ...
    wx.showModal({
      ...
      success: function (ress) {
        if (ress.confirm) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_love/index.php?s=/Little/Center/que',
            ...
            success: function (res) {
              ...
              if (res.data.info == 1) {
                wx.showToast({
                  ...
                  success:function(res){
                    wx.navigateTo({
                      url: '../fabu/fabu?id=' + e.currentTarget.id + '&types=' + e.currentTarget.dataset.type,
                    })
                  }
                })
                that.setData({
  ...
  delName:function(e){
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_love/index.php?s=/Little/Center/orders_del',
