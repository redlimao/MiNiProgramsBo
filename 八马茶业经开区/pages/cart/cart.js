    ...
    wx.login({
      success: function (ress) {
        if (ress.code) {
          ...
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_bama/index.php?s=/Little/Center/carss',
            data: { code: ress.code },
            method: "GET",
  ...
  delName(e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'https://www.bozhiyingxiao.com/little_program/store_bama/index.php?s=/Little/Del/index',
                              ...
                              wx.request({
                                  ...
                                  success: function (ress) {
                                      ...
                                      if (ress.data == 2) {
                                          ...
                                          wx.request({
                                              url: 'https://www.bozhiyingxiao.com/little_program/store_bama/index.php?s=/Little/Orders/indexs',
                                              data: { type: 2, status: 1, name: resss.userName, phone: resss.telNumber, address: address, cars: pay_list, dao: flag_dao, dian_id: dian_id,user_id: ress.data.user_id,},
                                              method: 'GET',
                                              success: function (res) {
                                                  console.log(res);
                                                  wx.showToast({
