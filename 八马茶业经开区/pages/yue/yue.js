...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://www.bozhiyingxiao.com/little_program/store_bama/index.php?s=/Little/Yuyue/index',
      data: {},
      method: "GET",
    ...
    if (e.detail.value.username==""){
      ...
      wx.login({
        success: function (ress) {
          if (ress.code) {
            wx.request({
              url: 'https://www.bozhiyingxiao.com/little_program/store_bama/index.php?s=/Little/Yuyue/yue',
