...
Page({
  ...
  onLoad: function (options) {
    var that=this;
    wx.request({
        url: 'https://www.bozhiyingxiao.com/little_program/store_bama/index.php?s=/Little/Cha/index',
      data: {},
      method: 'GET',
              ...
              wx.requestPayment({
                ...
                'success': function (ress) {
                  wx.showToast({
                    ...
                    success: function () {
                      wx.request({
                          url: 'https://www.bozhiyingxiao.com/little_program/store_bama/index.php?s=/Little/Cha/u_bi',
