...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.login({
      success:function(ress){
        if(ress.code){
          wx.request({
            url: 'https://www.ciqinfuwu.com/index.php?s=/Little/Info/goods',
  ...
  pingName:function(e){
    ...
    var that = this;
    wx.request({
      url: 'https://www.ciqinfuwu.com/index.php?s=/Little/Goods/ping',
      data: { id: shop_id },
      method: "GET",
      success: function (res) {
        if(res.data==1){
  ...
  jiaName:function(){
    ...
    wx.login({
      success:function(ress){
        if(ress.code){
          wx.request({
            url: 'https://www.ciqinfuwu.com/index.php?s=/Little/Goods/cars',
