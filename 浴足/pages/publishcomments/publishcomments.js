...
Page({
    ...
    formSubmit:function(e){
        ...
        if (e.detail.value.area == ''){
            ...
            wx.request({
                url: 'https://www.bozhiyingxiao.com/little_program/store_zuyu/index.php?s=/Little/Center/ping',
                data: { orders_id: that.data.orders_id, content: e.detail.value.area, one: that.data.star_num1, two: that.data.star_num2, status: that.data.flag_icon },
                method: "GET",
